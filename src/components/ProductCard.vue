    ...
    <div class="p-5 flex flex-col flex-grow">
      ...
      <div class="mt-auto flex items-center justify-between">
        ...
        <button 
          ...
          class="bg-primary hover:bg-primary-dark text-white p-2 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary dark:focus:ring-offset-gray-800"
          title="Add to Cart"
        >
